...
def save_detected_classes(detected_classes, save_dir):
    """Save unique detected class names to a file."""
    # Convert list to set to get unique classes
    unique_classes = list(set(detected_classes))
    
    # Create the file path
    classes_file = Path(save_dir) / 'detected_classes.txt'
    ...
    print(f"Detected classes saved to {classes_file}")
...
def detect(save_img=False):
    ...
    # List to store all detected classes across all images/frames
    ...
    # Save detected classes to file
    if len(all_detected_classes) > 0:
        save_detected_classes(all_detected_classes, save_dir)
